...
/*
 * I includede this here because I modified the original code
 * I added the 'service type', so an operator can choose to create a Kernel Driver
 */
...
) 
{
	...
	service_type = (DWORD)BeaconDataInt(&parser);
